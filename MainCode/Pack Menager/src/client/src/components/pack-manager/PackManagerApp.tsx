...
const PackManagerApp: React.FC = () => {
  ...
  const [currentVersion, setCurrentVersion] = useState('2.0.17');
      ...
      <div className="w-72 bg-black border-r border-zinc-800 flex flex-col">
        <div className="p-6 border-b border-zinc-800 draggable">
          <div className="flex items-center gap-3">
            ...
            <div className="font-semibold text-xl italic" style={{ fontFamily: 'Audiowide, sans-serif' }}>TGS PACK MANAGER</div>
                      </div>
